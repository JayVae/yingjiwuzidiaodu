    ...
    cellspacing="0" cellpadding="0" height="27">
        <tr>
          ...
          <td width="47%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
                <tr>
					<td width="100%" class="f3">项目群管理&gt;&gt;添加项目群</td>
                </tr>
            </table></td>
          <td width="50%"></td>
        </tr>
	...
	<tr>
		<td align="center" class="tr4"> 
			...
			<tr class="tr2">
				...
				<td  class="tr1" align="right">*项目群编码:</td>
			...
			<tr class="tr2">
					<!-- <td  class="tr1" align="right">*风险事件时限:</td>
					<td><input class="Wdate" type="text" name="timelimit" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"><font color=red>&lt;- 点击选择日期</font></td> -->
					<td  class="tr1" align="right">*所含项目数目</td>
					<td><input type="text" name="subnum" ></td>
					<td  class="tr1" align="right">项目群描述:</td>
